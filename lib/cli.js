...
exports.exec = function(options, done) {
  ...
  if (exports.args.l && typeof exports.args.l.value === 'string') {
  ...
  if (exports.args.e && typeof exports.args.e.value === 'string') {
    json = fs.readFileSync(exports.args.e.value).toString();
    eslintrc = JSON.parse(util.stripComments(json));
    platoOptions.eslint = eslintrc;
  }
